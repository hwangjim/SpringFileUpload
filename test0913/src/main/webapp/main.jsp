							...
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
										...
										<!-- 검색 -->
										<form action = "main.do" method = "post" enctype = "">
										<table>
										<thead>
													<tr>
										...
										<thead>
													<tr>
														...
														<th><input type = "text"  name = "content" placeholder = "내용" required></th>
														<th><input type = "hidden"  name = "writer" value = "${userId.name}"></th>
														<th><input type = "file" name = "uploadFile"></th>
														<th><input type = "submit" class = "button" value = "작성맨"></th>
														</tr>
												</thead>
