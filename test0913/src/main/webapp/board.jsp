											...
											<table>
												...
												<tbody>
													<tr>
														...
														<td><input type = "text" name = "writer" readonly value = "${data.writer}"></td>
														<td><input type = "text" name = "regdate" value = "${data.regdate}"></td>
														<td><input type = "file" name = "uploadFile"></td>
														<td><img src = "images/${data.fileName}">
													</tr>
												</tbody>
												<th><input type = "submit" class = "button" value = "UPDATE"><a href = "deleteB.do" class = "button">DELETE</a></th>
												</form>
												<tfoot>
													<tr>
